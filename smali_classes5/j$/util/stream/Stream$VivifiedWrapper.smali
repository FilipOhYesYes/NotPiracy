...
# virtual methods
.method public final synthetic N(Lj$/util/function/Consumer;)Lj$/util/stream/Stream;
    .locals 1
...
.method public final synthetic O(Lj$/util/function/Predicate;)Z
    .locals 1

    iget-object v0, p0, Lj$/util/stream/Stream$VivifiedWrapper;->a:Ljava/util/stream/Stream;

    invoke-static {p1}, Lj$/util/function/s0;->a(Lj$/util/function/Predicate;)Ljava/util/function/Predicate;
...
.method public final synthetic Q(Lj$/util/function/Function;)Lj$/util/stream/k0;
    .locals 1
...
.method public final synthetic X(Lj$/util/function/Predicate;)Z
    .locals 1
...
.method public final synthetic Z(Lj$/util/function/ToLongFunction;)Lj$/util/stream/k0;
    .locals 1

    iget-object v0, p0, Lj$/util/stream/Stream$VivifiedWrapper;->a:Ljava/util/stream/Stream;

    invoke-static {p1}, Lj$/util/function/x0;->a(Lj$/util/function/ToLongFunction;)Ljava/util/function/ToLongFunction;
...
.method public final synthetic c0(Lj$/util/function/ToDoubleFunction;)Lj$/util/stream/E;
    .locals 1

    iget-object v0, p0, Lj$/util/stream/Stream$VivifiedWrapper;->a:Ljava/util/stream/Stream;

    invoke-static {p1}, Lj$/util/function/v0;->a(Lj$/util/function/ToDoubleFunction;)Ljava/util/function/ToDoubleFunction;
...
.method public final synthetic findAny()Lj$/util/Optional;
    ...
    invoke-static {v0}, Lj$/util/z;->o(Ljava/util/Optional;)Lj$/util/Optional;
...
.method public final synthetic h0(Ljava/lang/Object;Lj$/util/function/BinaryOperator;)Ljava/lang/Object;
    .locals 1

    iget-object v0, p0, Lj$/util/stream/Stream$VivifiedWrapper;->a:Ljava/util/stream/Stream;

    invoke-static {p2}, Lj$/util/function/e;->a(Lj$/util/function/BinaryOperator;)Ljava/util/function/BinaryOperator;
...
.method public final synthetic k(Lj$/util/function/ToIntFunction;)Lj$/util/stream/IntStream;
    ...
    invoke-static {p1}, Lj$/util/function/w0;->a(Lj$/util/function/ToIntFunction;)Ljava/util/function/ToIntFunction;
...
.method public final synthetic max(Ljava/util/Comparator;)Lj$/util/Optional;
    ...
    invoke-static {p1}, Lj$/util/z;->o(Ljava/util/Optional;)Lj$/util/Optional;
...
.method public final synthetic o(Lj$/util/function/BinaryOperator;)Lj$/util/Optional;
    .locals 1

    iget-object v0, p0, Lj$/util/stream/Stream$VivifiedWrapper;->a:Ljava/util/stream/Stream;

    invoke-static {p1}, Lj$/util/function/e;->a(Lj$/util/function/BinaryOperator;)Ljava/util/function/BinaryOperator;
...
.method public final synthetic u(Ljava/lang/Object;Lj$/util/function/BiFunction;Lj$/util/function/BinaryOperator;)Ljava/lang/Object;
    .locals 1
    ...
    invoke-static {p3}, Lj$/util/function/e;->a(Lj$/util/function/BinaryOperator;)Ljava/util/function/BinaryOperator;
