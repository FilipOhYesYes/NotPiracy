...
.method public static synthetic convert(Lj$/util/stream/Stream;)Ljava/util/stream/Stream;
    ...
    iget-object p0, p0, Lj$/util/stream/Stream$VivifiedWrapper;->a:Ljava/util/stream/Stream;
...
.method public final synthetic collect(Ljava/util/function/Supplier;Ljava/util/function/BiConsumer;Ljava/util/function/BiConsumer;)Ljava/lang/Object;
    ...
    invoke-interface {v0, p1, p2, p3}, Lj$/util/stream/Stream;->h(Lj$/util/function/Supplier;Lj$/util/function/BiConsumer;Lj$/util/function/BiConsumer;)Ljava/lang/Object;
...
.method public final synthetic findAny()Ljava/util/Optional;
    ...
    invoke-static {v0}, Lj$/util/z;->u(Lj$/util/Optional;)Ljava/util/Optional;
...
.method public final synthetic flatMap(Ljava/util/function/Function;)Ljava/util/stream/Stream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->l(Lj$/util/function/Function;)Lj$/util/stream/Stream;
...
.method public final synthetic flatMapToDouble(Ljava/util/function/Function;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->w(Lj$/util/function/Function;)Lj$/util/stream/E;
...
.method public final synthetic flatMapToLong(Ljava/util/function/Function;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->Q(Lj$/util/function/Function;)Lj$/util/stream/k0;
...
.method public final synthetic mapToDouble(Ljava/util/function/ToDoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->c0(Lj$/util/function/ToDoubleFunction;)Lj$/util/stream/E;
...
.method public final synthetic mapToInt(Ljava/util/function/ToIntFunction;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->k(Lj$/util/function/ToIntFunction;)Lj$/util/stream/IntStream;
...
.method public final synthetic mapToLong(Ljava/util/function/ToLongFunction;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->Z(Lj$/util/function/ToLongFunction;)Lj$/util/stream/k0;
...
.method public final synthetic max(Ljava/util/Comparator;)Ljava/util/Optional;
    ...
    invoke-static {p1}, Lj$/util/z;->u(Lj$/util/Optional;)Ljava/util/Optional;
...
.method public final synthetic reduce(Ljava/lang/Object;Ljava/util/function/BiFunction;Ljava/util/function/BinaryOperator;)Ljava/lang/Object;
    ...
    invoke-static {p3}, Lj$/util/function/d;->a(Ljava/util/function/BinaryOperator;)Lj$/util/function/BinaryOperator;

    move-result-object p3

    invoke-interface {v0, p1, p2, p3}, Lj$/util/stream/Stream;->u(Ljava/lang/Object;Lj$/util/function/BiFunction;Lj$/util/function/BinaryOperator;)Ljava/lang/Object;
...
.method public final synthetic reduce(Ljava/lang/Object;Ljava/util/function/BinaryOperator;)Ljava/lang/Object;
    ...
    invoke-static {p2}, Lj$/util/function/d;->a(Ljava/util/function/BinaryOperator;)Lj$/util/function/BinaryOperator;

    move-result-object p2

    invoke-interface {v0, p1, p2}, Lj$/util/stream/Stream;->h0(Ljava/lang/Object;Lj$/util/function/BinaryOperator;)Ljava/lang/Object;
...
.method public final synthetic reduce(Ljava/util/function/BinaryOperator;)Ljava/util/Optional;
    ...
    invoke-static {p1}, Lj$/util/function/d;->a(Ljava/util/function/BinaryOperator;)Lj$/util/function/BinaryOperator;

    move-result-object p1

    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->o(Lj$/util/function/BinaryOperator;)Lj$/util/Optional;
