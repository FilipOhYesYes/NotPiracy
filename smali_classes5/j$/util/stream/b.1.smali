...
.method constructor <init>(Lj$/util/stream/b;I)V
    ...
    invoke-static {p2, v1}, Lj$/util/stream/S2;->q(II)I
    ...
    invoke-virtual {p0}, Lj$/util/stream/b;->y0()Z
...
.method private A0(I)Lj$/util/Spliterator;
    .locals 7
    ...
    invoke-virtual {v2}, Lj$/util/stream/b;->y0()Z
    ...
    invoke-virtual {v3, v4}, Lj$/util/stream/S2;->A(I)Z
    ...
    :cond_0
    invoke-virtual {v2, v0, v1}, Lj$/util/stream/b;->x0(Lj$/util/stream/b;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    invoke-static {v4, v0}, Lj$/util/stream/S2;->q(II)I
    ...
    invoke-static {p1, v0}, Lj$/util/stream/S2;->q(II)I
...
# virtual methods
.method final B0()Lj$/util/Spliterator;
    .locals 3
...
.method abstract C0(Lj$/util/stream/b;Lj$/util/function/Supplier;Z)Lj$/util/Spliterator;
.end method

.method final D0(Lj$/util/Spliterator;Lj$/util/stream/f2;)Lj$/util/stream/f2;
    .locals 1
    ...
    .line 0
    invoke-virtual {p0, p2}, Lj$/util/stream/b;->E0(Lj$/util/stream/f2;)Lj$/util/stream/f2;

    move-result-object v0

    invoke-virtual {p0, p1, v0}, Lj$/util/stream/b;->i0(Lj$/util/Spliterator;Lj$/util/stream/f2;)V

    return-object p2
.end method

.method final E0(Lj$/util/stream/f2;)Lj$/util/stream/f2;
    .locals 3
    ...
    invoke-virtual {v0, v2, p1}, Lj$/util/stream/b;->z0(ILj$/util/stream/f2;)Lj$/util/stream/f2;
...
.method final F0(Lj$/util/Spliterator;)Lj$/util/Spliterator;
    ...
    .line 0
    invoke-virtual {p0, p0, v0, p1}, Lj$/util/stream/b;->C0(Lj$/util/stream/b;Lj$/util/function/Supplier;Z)Lj$/util/Spliterator;
...
.method final i0(Lj$/util/Spliterator;Lj$/util/stream/f2;)V
    .locals 2
    ...
    invoke-interface {p2, v0, v1}, Lj$/util/stream/f2;->n(J)V

    invoke-interface {p1, p2}, Lj$/util/Spliterator;->a(Lj$/util/function/Consumer;)V

    invoke-interface {p2}, Lj$/util/stream/f2;->m()V

    goto :goto_0

    :cond_0
    invoke-virtual {p0, p1, p2}, Lj$/util/stream/b;->j0(Lj$/util/Spliterator;Lj$/util/stream/f2;)V
...
.method final j0(Lj$/util/Spliterator;Lj$/util/stream/f2;)V
    ...
    invoke-interface {p2, v1, v2}, Lj$/util/stream/f2;->n(J)V

    invoke-virtual {v0, p1, p2}, Lj$/util/stream/b;->p0(Lj$/util/Spliterator;Lj$/util/stream/f2;)V
...
.method final k0(Lj$/util/Spliterator;ZLj$/util/function/IntFunction;)Lj$/util/stream/H0;
    .locals 2
    ...
    .line 0
    invoke-virtual {p0, p0, p1, p2, p3}, Lj$/util/stream/b;->n0(Lj$/util/stream/b;Lj$/util/Spliterator;ZLj$/util/function/IntFunction;)Lj$/util/stream/H0;
    ...
    invoke-virtual {p0, v0, v1, p3}, Lj$/util/stream/b;->v0(JLj$/util/function/IntFunction;)Lj$/util/stream/z0;

    move-result-object p2

    invoke-virtual {p0, p1, p2}, Lj$/util/stream/b;->D0(Lj$/util/Spliterator;Lj$/util/stream/f2;)Lj$/util/stream/f2;

    invoke-interface {p2}, Lj$/util/stream/z0;->b()Lj$/util/stream/H0;
...
.method final l0(Lj$/util/stream/x3;)Ljava/lang/Object;
    .locals 1
    ...
    .line 0
    invoke-interface {p1}, Lj$/util/stream/x3;->d()I

    move-result v0

    invoke-direct {p0, v0}, Lj$/util/stream/b;->A0(I)Lj$/util/Spliterator;

    move-result-object v0

    invoke-interface {p1, p0, v0}, Lj$/util/stream/x3;->c(Lj$/util/stream/b;Lj$/util/Spliterator;)Ljava/lang/Object;
    ...
    invoke-interface {p1, p0, v0}, Lj$/util/stream/x3;->a(Lj$/util/stream/b;Lj$/util/Spliterator;)Ljava/lang/Object;
...
.method final m0(Lj$/util/function/IntFunction;)Lj$/util/stream/H0;
    .locals 4
    ...
    invoke-direct {v1, v2}, Lj$/util/stream/b;->A0(I)Lj$/util/Spliterator;

    move-result-object v0

    invoke-virtual {p0, v1, v0, p1}, Lj$/util/stream/b;->w0(Lj$/util/stream/b;Lj$/util/Spliterator;Lj$/util/function/IntFunction;)Lj$/util/stream/H0;
    ...
    :cond_0
    invoke-direct {p0, v2}, Lj$/util/stream/b;->A0(I)Lj$/util/Spliterator;

    move-result-object v1

    invoke-virtual {p0, v1, v0, p1}, Lj$/util/stream/b;->k0(Lj$/util/Spliterator;ZLj$/util/function/IntFunction;)Lj$/util/stream/H0;
...
.method abstract n0(Lj$/util/stream/b;Lj$/util/Spliterator;ZLj$/util/function/IntFunction;)Lj$/util/stream/H0;
.end method

.method final o0(Lj$/util/Spliterator;)J
    .locals 2
...
.method public final onClose(Ljava/lang/Runnable;)Lj$/util/stream/h;
    ...
    invoke-direct {v2, v1, p1}, Lj$/util/stream/w3;-><init>(Ljava/lang/Runnable;Ljava/lang/Runnable;)V
...
.method abstract p0(Lj$/util/Spliterator;Lj$/util/stream/f2;)V
.end method
...
.method final r0()Lj$/util/stream/T2;
    ...
    :cond_0
    invoke-virtual {v0}, Lj$/util/stream/b;->q0()Lj$/util/stream/T2;
...
.method public spliterator()Lj$/util/Spliterator;
    ...
    .line 0
    invoke-virtual {p0, p0, v1, v0}, Lj$/util/stream/b;->C0(Lj$/util/stream/b;Lj$/util/function/Supplier;Z)Lj$/util/Spliterator;
...
.method final synthetic u0()Lj$/util/Spliterator;
    .locals 1
...
.method abstract v0(JLj$/util/function/IntFunction;)Lj$/util/stream/z0;
.end method

.method w0(Lj$/util/stream/b;Lj$/util/Spliterator;Lj$/util/function/IntFunction;)Lj$/util/stream/H0;
    .locals 0
...
.method x0(Lj$/util/stream/b;Lj$/util/Spliterator;)Lj$/util/Spliterator;
    .locals 2
    ...
    .line 0
    invoke-virtual {p0, p1, p2, v0}, Lj$/util/stream/b;->w0(Lj$/util/stream/b;Lj$/util/Spliterator;Lj$/util/function/IntFunction;)Lj$/util/stream/H0;

    move-result-object p1

    invoke-interface {p1}, Lj$/util/stream/H0;->spliterator()Lj$/util/Spliterator;
...
.method abstract y0()Z
.end method

.method abstract z0(ILj$/util/stream/f2;)Lj$/util/stream/f2;
.end method
