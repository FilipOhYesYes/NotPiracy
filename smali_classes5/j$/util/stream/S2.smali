...
.method static constructor <clinit>()V
    ...
    new-instance v5, Lj$/util/stream/S2;

    sget-object v6, Lj$/util/stream/R2;->SPLITERATOR:Lj$/util/stream/R2;

    invoke-static {v6}, Lj$/util/stream/S2;->Q(Lj$/util/stream/R2;)Lj$/util/stream/Q2;

    move-result-object v7

    sget-object v8, Lj$/util/stream/R2;->STREAM:Lj$/util/stream/R2;

    invoke-virtual {v7, v8}, Lj$/util/stream/Q2;->a(Lj$/util/stream/R2;)V

    sget-object v9, Lj$/util/stream/R2;->OP:Lj$/util/stream/R2;
    ...
    .line 0
    iget-object v11, v7, Lj$/util/stream/Q2;->a:Ljava/util/Map;
    ...
    invoke-direct {v5, v10, v2, v2, v7}, Lj$/util/stream/S2;-><init>(Ljava/lang/String;IILj$/util/stream/Q2;)V

    sput-object v5, Lj$/util/stream/S2;->DISTINCT:Lj$/util/stream/S2;
    ...
    invoke-virtual {v10, v8}, Lj$/util/stream/Q2;->a(Lj$/util/stream/R2;)V
    ...
    .line 0
    iget-object v12, v10, Lj$/util/stream/Q2;->a:Ljava/util/Map;
    ...
    invoke-direct {v7, v11, v4, v4, v10}, Lj$/util/stream/S2;-><init>(Ljava/lang/String;IILj$/util/stream/Q2;)V

    sput-object v7, Lj$/util/stream/S2;->SORTED:Lj$/util/stream/S2;

    new-instance v10, Lj$/util/stream/S2;

    invoke-static {v6}, Lj$/util/stream/S2;->Q(Lj$/util/stream/R2;)Lj$/util/stream/Q2;

    move-result-object v11

    invoke-virtual {v11, v8}, Lj$/util/stream/Q2;->a(Lj$/util/stream/R2;)V
    ...
    .line 0
    iget-object v13, v11, Lj$/util/stream/Q2;->a:Ljava/util/Map;

    invoke-interface {v13, v9, v12}, Ljava/util/Map;->put(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;

    .line 0
    sget-object v12, Lj$/util/stream/R2;->TERMINAL_OP:Lj$/util/stream/R2;
    ...
    .line 0
    sget-object v14, Lj$/util/stream/R2;->UPSTREAM_TERMINAL_OP:Lj$/util/stream/R2;
    ...
    invoke-direct {v10, v13, v1, v1, v11}, Lj$/util/stream/S2;-><init>(Ljava/lang/String;IILj$/util/stream/Q2;)V

    sput-object v10, Lj$/util/stream/S2;->ORDERED:Lj$/util/stream/S2;
    ...
    invoke-virtual {v13, v8}, Lj$/util/stream/Q2;->a(Lj$/util/stream/R2;)V
    ...
    .line 0
    iget-object v1, v13, Lj$/util/stream/Q2;->a:Ljava/util/Map;
    ...
    invoke-direct {v11, v1, v3, v3, v13}, Lj$/util/stream/S2;-><init>(Ljava/lang/String;IILj$/util/stream/Q2;)V

    sput-object v11, Lj$/util/stream/S2;->SIZED:Lj$/util/stream/S2;

    new-instance v1, Lj$/util/stream/S2;

    invoke-static {v9}, Lj$/util/stream/S2;->Q(Lj$/util/stream/R2;)Lj$/util/stream/Q2;

    move-result-object v13

    invoke-virtual {v13, v12}, Lj$/util/stream/Q2;->a(Lj$/util/stream/R2;)V

    const/16 v15, 0xc

    const-string v3, "SHORT_CIRCUIT"

    invoke-direct {v1, v3, v0, v15, v13}, Lj$/util/stream/S2;-><init>(Ljava/lang/String;IILj$/util/stream/Q2;)V

    sput-object v1, Lj$/util/stream/S2;->SHORT_CIRCUIT:Lj$/util/stream/S2;

    const/4 v3, 0x5

    new-array v3, v3, [Lj$/util/stream/S2;
    ...
    sput-object v3, Lj$/util/stream/S2;->v:[Lj$/util/stream/S2;

    invoke-static {v6}, Lj$/util/stream/S2;->r(Lj$/util/stream/R2;)I

    move-result v0

    sput v0, Lj$/util/stream/S2;->f:I

    invoke-static {v8}, Lj$/util/stream/S2;->r(Lj$/util/stream/R2;)I

    move-result v0

    sput v0, Lj$/util/stream/S2;->g:I

    invoke-static {v9}, Lj$/util/stream/S2;->r(Lj$/util/stream/R2;)I

    move-result v0

    sput v0, Lj$/util/stream/S2;->h:I

    invoke-static {v12}, Lj$/util/stream/S2;->r(Lj$/util/stream/R2;)I

    invoke-static {v14}, Lj$/util/stream/S2;->r(Lj$/util/stream/R2;)I
    ...
    iget v5, v5, Lj$/util/stream/S2;->e:I
...
.method private static Q(Lj$/util/stream/R2;)Lj$/util/stream/Q2;
    .locals 3
...
.method private static r(Lj$/util/stream/R2;)I
    .locals 6
...
.method static y(Lj$/util/Spliterator;)I
    .locals 3
