...
.method private synthetic constructor <init>(Ljava/util/stream/LongStream;)V
    ...
    iput-object p1, p0, Lj$/util/stream/i0;->a:Ljava/util/stream/LongStream;

    return-void
.end method

.method public static synthetic i0(Ljava/util/stream/LongStream;)Lj$/util/stream/k0;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lj$/util/stream/i0;-><init>(Ljava/util/stream/LongStream;)V
...
# virtual methods
.method public final synthetic C(Lj$/util/function/X;)Z
    .locals 1

    .line 0
    iget-object v0, p0, Lj$/util/stream/i0;->a:Ljava/util/stream/LongStream;
    ...
    .line 0
    :cond_0
    iget-object p1, p1, Lj$/util/function/X;->a:Ljava/util/function/LongPredicate;
...
.method public final synthetic E(Lj$/util/function/X;)Z
    .locals 1
...
.method public final synthetic K(Lj$/util/function/W;)Lj$/util/stream/Stream;
    .locals 1

    iget-object v0, p0, Lj$/util/stream/i0;->a:Ljava/util/stream/LongStream;

    invoke-static {p1}, Lj$/util/function/V;->a(Lj$/util/function/W;)Ljava/util/function/LongFunction;
...
.method public final synthetic M(Lj$/util/function/X;)Lj$/util/stream/k0;
    .locals 1
...
.method public final synthetic U(Lj$/util/function/T;)V
    .locals 1
...
.method public final synthetic Y(Lj$/util/function/Supplier;Lj$/util/function/p0;Lj$/util/function/BiConsumer;)Ljava/lang/Object;
    .locals 1
    ...
    invoke-static {p2}, Lj$/util/function/o0;->a(Lj$/util/function/p0;)Ljava/util/function/ObjLongConsumer;
...
.method public final synthetic equals(Ljava/lang/Object;)Z
    ...
    iget-object p1, p1, Lj$/util/stream/i0;->a:Ljava/util/stream/LongStream;
...
.method public final synthetic findAny()Lj$/util/k;
    ...
    invoke-static {v0}, Lj$/util/z;->t(Ljava/util/OptionalLong;)Lj$/util/k;
...
.method public final synthetic g(Lj$/util/function/O;)Lj$/util/k;
    .locals 1
    ...
    invoke-static {p1}, Lj$/util/z;->t(Ljava/util/OptionalLong;)Lj$/util/k;
...
.method public final synthetic iterator()Lj$/util/w;
    ...
    invoke-static {v0}, Lj$/util/u;->b(Ljava/util/PrimitiveIterator$OfLong;)Lj$/util/w;
...
.method public final synthetic m(Lj$/util/function/T;)Lj$/util/stream/k0;
    .locals 1
...
.method public final synthetic n(Lj$/util/function/W;)Lj$/util/stream/k0;
    .locals 1
...
.method public final synthetic p(Lj$/util/function/Z;)Lj$/util/stream/E;
    .locals 1
...
.method public final synthetic s(Lj$/util/function/X;)Z
    .locals 1
...
.method public final synthetic spliterator()Lj$/util/I;
    ...
    invoke-static {v0}, Lj$/util/G;->b(Ljava/util/Spliterator$OfLong;)Lj$/util/I;
...
.method public final synthetic t(Lj$/util/function/g0;)Lj$/util/stream/k0;
    .locals 1
...
.method public final synthetic y(Lj$/util/function/b0;)Lj$/util/stream/IntStream;
    .locals 1
