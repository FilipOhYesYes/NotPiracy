...
.method public final createFromAssets(Landroid/content/res/AssetManager;Ljava/lang/String;Landroid/content/Context;Landroidx/compose/ui/text/font/FontVariation$Settings;)Landroid/graphics/Typeface;
    ...
    .line 5
    :cond_0
    invoke-static {p1, p2}, LUe/o;->a(Landroid/content/res/AssetManager;Ljava/lang/String;)Landroid/graphics/Typeface$Builder;
    ...
    .line 13
    invoke-static {p1, p2}, LUe/k;->f(Landroid/graphics/Typeface$Builder;[Landroid/graphics/fonts/FontVariationAxis;)Landroid/graphics/Typeface$Builder;
    ...
    .line 17
    invoke-static {p1}, LUe/l;->c(Landroid/graphics/Typeface$Builder;)Landroid/graphics/Typeface;
...
.method public final createFromFile(Ljava/io/File;Landroid/content/Context;Landroidx/compose/ui/text/font/FontVariation$Settings;)Landroid/graphics/Typeface;
    ...
    .line 5
    :cond_0
    invoke-static {p1}, LUe/n;->b(Ljava/io/File;)Landroid/graphics/Typeface$Builder;
...
.method public final createFromFileDescriptor(Landroid/os/ParcelFileDescriptor;Landroid/content/Context;Landroidx/compose/ui/text/font/FontVariation$Settings;)Landroid/graphics/Typeface;
    ...
    .line 12
    invoke-static {p1}, LUe/p;->b(Ljava/io/FileDescriptor;)Landroid/graphics/Typeface$Builder;
