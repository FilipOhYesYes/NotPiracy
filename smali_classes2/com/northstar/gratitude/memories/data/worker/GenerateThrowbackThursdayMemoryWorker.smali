.class public final Lcom/northstar/gratitude/memories/data/worker/GenerateThrowbackThursdayMemoryWorker;
.super Landroidx/work/CoroutineWorker;
.source "GenerateThrowbackThursdayMemoryWorker.kt"
...
.method public constructor <init>(Landroid/content/Context;Landroidx/work/WorkerParameters;Ls8/i;)V
    ...
    const-string v4, "memoriesRepository"
    ...
    iput-object p1, v1, Lcom/northstar/gratitude/memories/data/worker/GenerateThrowbackThursdayMemoryWorker;->a:Landroid/content/Context;

    const/4 v3, 0x3

    iput-object p3, v1, Lcom/northstar/gratitude/memories/data/worker/GenerateThrowbackThursdayMemoryWorker;->b:Ls8/i;
...
.method public final c(Ljava/lang/String;)V
    ...
    iget-object v0, v5, Lcom/northstar/gratitude/memories/data/worker/GenerateThrowbackThursdayMemoryWorker;->a:Landroid/content/Context;
    ...
    const-string v8, "Throwback Thursday Notification"
    ...
    const-string v8, "gratefulnessReminders"
    ...
    const-string v8, "setContentIntent(...)"
...
.method public final doWork(LUd/d;)Ljava/lang/Object;
    ...
    instance-of v0, p1, Lcom/northstar/gratitude/memories/data/worker/GenerateThrowbackThursdayMemoryWorker$a;
    ...
    check-cast v0, Lcom/northstar/gratitude/memories/data/worker/GenerateThrowbackThursdayMemoryWorker$a;

    const/4 v6, 0x7

    iget v1, v0, Lcom/northstar/gratitude/memories/data/worker/GenerateThrowbackThursdayMemoryWorker$a;->d:I
    ...
    iput v1, v0, Lcom/northstar/gratitude/memories/data/worker/GenerateThrowbackThursdayMemoryWorker$a;->d:I
    ...
    new-instance v0, Lcom/northstar/gratitude/memories/data/worker/GenerateThrowbackThursdayMemoryWorker$a;

    const/4 v6, 0x1

    invoke-direct {v0, v4, p1}, Lcom/northstar/gratitude/memories/data/worker/GenerateThrowbackThursdayMemoryWorker$a;-><init>(Lcom/northstar/gratitude/memories/data/worker/GenerateThrowbackThursdayMemoryWorker;LUd/d;)V

    const/4 v6, 0x7

    :goto_0
    iget-object p1, v0, Lcom/northstar/gratitude/memories/data/worker/GenerateThrowbackThursdayMemoryWorker$a;->b:Ljava/lang/Object;
    ...
    iget v2, v0, Lcom/northstar/gratitude/memories/data/worker/GenerateThrowbackThursdayMemoryWorker$a;->d:I
    ...
    iget-object v0, v0, Lcom/northstar/gratitude/memories/data/worker/GenerateThrowbackThursdayMemoryWorker$a;->a:Lcom/northstar/gratitude/memories/data/worker/GenerateThrowbackThursdayMemoryWorker;
    ...
    iput-object v4, v0, Lcom/northstar/gratitude/memories/data/worker/GenerateThrowbackThursdayMemoryWorker$a;->a:Lcom/northstar/gratitude/memories/data/worker/GenerateThrowbackThursdayMemoryWorker;

    const/4 v6, 0x6

    iput v3, v0, Lcom/northstar/gratitude/memories/data/worker/GenerateThrowbackThursdayMemoryWorker$a;->d:I

    const/4 v6, 0x2

    iget-object p1, v4, Lcom/northstar/gratitude/memories/data/worker/GenerateThrowbackThursdayMemoryWorker;->b:Ls8/i;
    ...
    invoke-virtual {v0, v2}, Lcom/northstar/gratitude/memories/data/worker/GenerateThrowbackThursdayMemoryWorker;->c(Ljava/lang/String;)V
